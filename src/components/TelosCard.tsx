...
export const TelosCard = ({ img }: { img: (string | null)[] }) => {
    return (
        <div className="flex-initial w-[340px] p-[15px] shadow bg-gradient">
            {/* Header */}
            ...
            <div className="grid gap-[10px] grid-cols-2  mb-[10px]">
                {/* Option 1 */}
                <div className="bg-gradient-2 p-[15px] pt-[20px] transition duration-1000 outline-blue-700">
                    {/* Name */}
            ...
            {/* Bar */}
            <div className="bg-gradient-2 h-70 mb-[15px] flex place-content-between items-center px-4">
            ...
            {/* Pool prize */}
            <div className="h-[70px] bg-darkblue-500 rounded-xl px-[15px] flex place-content-between mb-4">
